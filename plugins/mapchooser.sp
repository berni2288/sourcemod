...
new Handle:g_Cvar_Bonusroundtime = null;

/* Plugin ConVars */
new Handle:g_Cvar_StartTime = null;
new Handle:g_Cvar_StartRounds = null;
new Handle:g_Cvar_StartFrags = null;
new Handle:g_Cvar_ExtendTimeStep = null;
new Handle:g_Cvar_ExtendRoundStep = null;
new Handle:g_Cvar_ExtendFragStep = null;
new Handle:g_Cvar_ExcludeMaps = null;
new Handle:g_Cvar_IncludeMaps = null;
new Handle:g_Cvar_NoVoteMode = null;
new Handle:g_Cvar_Extend = null;
new Handle:g_Cvar_DontChange = null;
new Handle:g_Cvar_EndOfMapVote = null;
new Handle:g_Cvar_VoteDuration = null;
new Handle:g_Cvar_RunOff = null;
new Handle:g_Cvar_RunOffPercent = null;

new Handle:g_VoteTimer = null;
new Handle:g_RetryTimer = null;
...
public OnConfigsExecuted()
{
	...
	if ((g_Cvar_Bonusroundtime != null) && !GetConVarInt(g_Cvar_StartRounds))
	{
...
{
	if (!GetArraySize(g_MapList) || g_Cvar_Fraglimit == null || g_HasVoteStarted)
	{
		return;
	}
...
InitiateVote(MapChange:when, Handle:inputlist=null)
{
	...
	g_VoteMenu = Menu(Handler_MapVoteMenu, MenuAction:MENU_ACTIONS_ALL);
						   ...
						   const item_info[][2])
{
	if (GetConVarBool(g_Cvar_RunOff) && num_items > 1)
	{
		...
		float required = num_votes * (GetConVarFloat(g_Cvar_RunOffPercent) / 100.0);
